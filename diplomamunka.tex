...
\section{Kiegészítés} % TODO valami takarítás
...
\end{align*}
ahol $\left( , \right)_{l_2}$ az $l_2$-beli skaláris szorzást jelöli, és erre alkalmaztuk a Cauchy-Bunyakovsky-Scwarz-egyenlőtlenséget. Ha $\norm{(u, \Phi_k)}_{l_2} = 1$ (ami $u = \Phi_k$ választással biztosítható), akkor megkaptuk, hogy $\mu(H_m) \leq \alpha \sigma(m)$. %TODO alpha hogy jön be? talán legyen alpha > 1 a kezdeti megkötés, és így nincs gond
